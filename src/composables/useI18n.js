  ...
  zh: {
    ...
    about: {
      ...
      intro: {
        ...
        paragraphs: [
          '微思敦集团创立于2014年，汇聚500多位营销人才。',
          '集团下设微思敦、WSD、皓量科技、思多睿、海月昇、取泊、游友广告、拾刻互动、吉讯互动等子公司，核心业务涵盖社交广告、达人营销、口碑营销、社交电商、营销培训、营销技术等。',
          '微思敦集团作为微信、小红书、B站、Instagram、LinkedIn、Reddit等社交媒体的深度商业合作伙伴，长期服务宝洁、名创优品、小米、安克创新、小熊电器等知名品牌，多次获得行业大奖认可。',
          '微思敦独创ACT营销模型，依托自研微思敦客户中心营销平台，聚合广告Advertising、内容Content、交易Transaction三维能力，帮助品牌更科学地实现跨越式增长。',
      ...
      brands: [
        ['微思敦官方Logo', '好品牌 会社交', '以品牌目标为驱动、以用户需求为核心、以社交媒体为平台，为品牌提供可持续、可循环、可衡量的系统性社交营销服务。', localAbout('brand-wsd.webp')],
